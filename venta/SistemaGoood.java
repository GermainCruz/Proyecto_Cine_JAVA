...
public class SistemaGoood {
    ...
    private static void registrarVenta(Connection connection, Scanner scanner) throws SQLException {
        ...
        // Agregar detalles de entradas
        agregarDetalles(connection, scanner, idVenta);

        // Preguntar si el cliente es socio después de seleccionar entradas
        ...
        // Actualizar la venta con información del cliente
        actualizarVentaConCliente(connection, idVenta, idCliente, tipoDocumento, numeroDocumento);
        ...
        // Actualizar la venta con el método de pago
        actualizarVentaConPago(connection, idVenta, metodoPago, numeroTarjeta, cvv, fechaVencimiento, numeroCelular);
